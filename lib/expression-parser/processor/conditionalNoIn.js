...
var utils = {
    ...
    logicalOR: function (state) {
        return state.expressionProcessor.token(state, ["logicalORNoIn"]);
    },
    ...
    assignmentNoIn: function (state) {
        return state.expressionProcessor.token(state, ["assignmentNoIn"]);
    }
    ...
    process: function(state) {
        ...
        state.levelDown();
            ...
            if(utils.questionMark(state)) {
                ...
                if(!utils.assignmentNoIn(state)) return false;
            }
        state.levelUp();
        return true;
    }
