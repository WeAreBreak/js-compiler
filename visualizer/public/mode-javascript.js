...
ace.define("ace/mode/javascript_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var JavaScriptHighlightRules = function(options) {
        var keywordMapper = this.createKeywordMapper({
            ...
            "break|case|catch|continue|default|delete|do|else|finally|for|function|on|" +
            "if|in|instanceof|new|return|switch|throw|try|typeof|let|var|while|with|debugger|" +
            "__parent__|__count__|escape|unescape|with|__proto__|" +
            "class|enum|extends|super|export|implements|private|public|interface|package|protected|static",
            "storage.type":
                "const|let|var|function|on",
            "constant.language":
        ...
        this.$rules = {
            "no_regex" : [
                ...
                DocCommentHighlightRules.getStartRule("doc-start"),
                {
                    ...
                    regex : "(" + identifierRe + ")(\\.)(" + identifierRe +")(\\s*)(=)(\\s*)(function|on)(\\s+)(\\w+)(\\s*)(\\()",
                    next: "function_arguments"
                }, {
                    token : [
                        "storage.type", "text", "entity.name.function", "text", "paren.lparen"
                    ],
                    regex : "(function|on)(\\s+)(" + identifierRe + ")(\\s*)(\\()",
                    next: "function_arguments"
                }, {
                    token : [
                    ...
                    regex : "(" + identifierRe + ")(\\s*)(:)(\\s*)(function|on)(\\s*)(\\()",
                    next: "function_arguments"
                }, {
                    token : [
                        "text", "text", "storage.type", "text", "paren.lparen"
                    ],
                    regex : "(:)(\\s*)(function|on)(\\s*)(\\()",
                    next: "function_arguments"
                }, {
                    token : "keyword",
                    regex : "(?:" + kwBeforeRe + ")\\b",
